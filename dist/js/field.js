...
/* harmony import */ var _mixins_mixins__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../mixins/mixins */ "./resources/js/mixins/mixins.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [_mixins_mixins__WEBPACK_IMPORTED_MODULE_0__["DetailValues"], _mixins_mixins__WEBPACK_IMPORTED_MODULE_0__["ToggleBuilder"]],
  ...
  methods: {
     ...
     * @return {void}
     */
    initializeScriptGrammar: function initializeScriptGrammar(grammar) {
...
/* harmony import */ var _mixins_mixins__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../mixins/mixins */ "./resources/js/mixins/mixins.js");
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  mixins: [laravel_nova__WEBPACK_IMPORTED_MODULE_0__["HandlesValidationErrors"], _mixins_mixins__WEBPACK_IMPORTED_MODULE_1__["FormValues"], _mixins_mixins__WEBPACK_IMPORTED_MODULE_1__["ToggleBuilder"]],
...
var render = function() {
  ...
  return _vm.conditionIsTrue()
    ? _c("detail-" + _vm.field.field.component, {
        tag: "component",
        attrs: {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ScriptGrammar; });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ScriptGrammar = /*#__PURE__*/function () {
  /**
  ...
  _createClass(ScriptGrammar, [{
    ...
    value: function compileWheres(query) {
      ...
      var clauses = this.compileWheresToArray(query); // If there aren't any clauses, stop here
    ...
    value: function compileWheresToArray(query) {
      ...
      return query.wheres.map(function (where) {
        var callback = _this['where' + where.type];
        ...
        return {
          ...
          'callback': callback.call(_this, query, where)
        };
      });
    }
    /**
    ...
    value: function evaluateWhereClauses(query, clauses) {
      return function () {
        return clauses.reduce(function (result, clause) {
          ...
          var value = clause.callback(); // Determine the result by the boolean
    ...
    value: function whereBasic(query, where) {
      // Determine the value
      var value = where.value; // Determine the callback for the column value

      var column = this.column(where.column); // Determine the operator

      var operator = where.operator; // Determine the callback by the operator
    ...
    key: "whereIn",
    value: function whereIn(query, where) {
      // Determine the values
      var values = where.values; // Determine the callback for the column value

      var column = this.column(where.column); // Return the evaluating callback
    ...
    key: "whereNotIn",
    value: function whereNotIn(query, where) {
      // Determine the values
      var values = where.values; // Determine the callback for the column value
    ...
    key: "whereNull",
    value: function whereNull(query, where) {
    ...
    key: "whereNotNull",
    value: function whereNotNull(query, where) {
      // Determine the callback for the column value
      var column = this.column(where.column); // Return the evaluating callback
...
Nova.booting(function (Vue, router) {
  Vue.component('index-value-toggle', __webpack_require__(/*! ./components/IndexField */ "./resources/js/components/IndexField.vue")["default"]);
  Vue.component('detail-value-toggle', __webpack_require__(/*! ./components/DetailField */ "./resources/js/components/DetailField.vue")["default"]);
  Vue.component('form-value-toggle', __webpack_require__(/*! ./components/FormField */ "./resources/js/components/FormField.vue")["default"]);
});

/***/ }),

/***/ "./resources/js/mixins/DetailValues.js":
/*!*********************************************!*\
  !*** ./resources/js/mixins/DetailValues.js ***!
  \*********************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  methods: {
    ...
    getFieldValue: function getFieldValue(key) {
      // Determine the field
      var field = this.getField(key) || {}; // Return the value
    ...
    getField: function getField(key) {
      ...
      var fields = this.resource.fields; // Search the fields for the specified field

      for (var i = 0; i < fields.length; i++) {
        // Determine the field
        var field = fields[i]; // Return the field on a match
...
/***/ "./resources/js/mixins/FormValues.js":
/*!*******************************************!*\
  !*** ./resources/js/mixins/FormValues.js ***!
  \*******************************************/
/*! exports provided: default */
...
/* harmony default export */ __webpack_exports__["default"] = ({
  methods: {
    ...
    getField: function getField(key) {
      // Determine the fields
      var fields = this.getFormFieldComponents(); // Search the fields for the specified field
    ...
    getFormFieldComponents: function getFormFieldComponents() {
      ...
      var descendants = this.getFormDescendants(); // Return the form field components
    ...
    getFormComponent: function getFormComponent() {
      ...
      var node = this.$parent; // Walk up the parent chain
      ...
      while (typeof node !== 'undefined' && node !== null) {
        ...
        if (_typeof(node.action) === 'object' && _typeof(node.action.fields) === 'object') {
          return node;
        } // Walk up the chain
    ...
    getComponentDescendants: function getComponentDescendants(component) {
      ...
      var descendants = []; // Determine the direct children of the component

      var children = component.$children; // Iterate through each child

      for (var i = 0; i < children.length; i++) {
        // Determine the current child
        var child = children[i]; // Add the child to the list of descendants

        descendants.push(child); // Determine the grandchildren

        var grandchildren = this.getComponentDescendants(child); // Push the grandchildren to the list of descendants
...
/***/ "./resources/js/mixins/ToggleBuilder.js":
/*!**********************************************!*\
  !*** ./resources/js/mixins/ToggleBuilder.js ***!
  \**********************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ScriptGrammar_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../ScriptGrammar.js */ "./resources/js/ScriptGrammar.js");
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    newScriptGrammar: function newScriptGrammar() {
      var grammar = new _ScriptGrammar_js__WEBPACK_IMPORTED_MODULE_0__["default"]();
...
/*!***************************************!*\
  !*** ./resources/js/mixins/mixins.js ***!
  \***************************************/
/*! exports provided: DetailValues, FormValues, ToggleBuilder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _FormValues__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./FormValues */ "./resources/js/mixins/FormValues.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "FormValues", function() { return _FormValues__WEBPACK_IMPORTED_MODULE_0__["default"]; });

/* harmony import */ var _DetailValues__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./DetailValues */ "./resources/js/mixins/DetailValues.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "DetailValues", function() { return _DetailValues__WEBPACK_IMPORTED_MODULE_1__["default"]; });

/* harmony import */ var _ToggleBuilder__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ToggleBuilder */ "./resources/js/mixins/ToggleBuilder.js");
/* harmony reexport (safe) */ __webpack_require__.d(__webpack_exports__, "ToggleBuilder", function() { return _ToggleBuilder__WEBPACK_IMPORTED_MODULE_2__["default"]; });
...
__webpack_require__(/*! F:\Program Files (x86)\Wamp\3.1.7\www\projects\jira-nova\vendor\reedware\nova-value-toggle\resources\js\field.js */"./resources/js/field.js");
module.exports = __webpack_require__(/*! F:\Program Files (x86)\Wamp\3.1.7\www\projects\jira-nova\vendor\reedware\nova-value-toggle\resources\sass\field.scss */"./resources/sass/field.scss");
